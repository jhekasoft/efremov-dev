...
function JavaScriptIcon() {
  return (
    <svg
      ...
      viewBox="0 0 256 256"
    >
      <rect width="256" height="256" fill="#F7DF1E" rx="25"></rect>
  ...
  return (
    ...
    >
      <g transform="matrix(.84833 0 0 .84833 -7.884 -9.45)">
        <use fill="#a41e11" xlinkHref="#B"></use>
        <path
          fill="#d82c20"
        ...
        ></path>
        <use y="-6.218" fill="#a41e11" xlinkHref="#B"></use>
        <use fill="#d82c20" xlinkHref="#C"></use>
        <path
          fill="#a41e11"
        ...
        ></path>
        <use y="-6.449" fill="#d82c20" xlinkHref="#C"></use>
        <g fill="#fff">
          ...
          <ellipse cx="20.444" cy="21.402" rx="4.672" ry="1.811"></ellipse>
        </g>
        <path fill="#7a0c00" d="M42.132 21.138l-5.17 2.042-.004-4.087z"></path>
        <path
          fill="#ad2115"
  ...
  return (
    ...
    >
      <g>
        <path
          fill="#FFF"
          d="M7.1 133.9v46.7c73.8.1 134 59.3 135 132.4h45.5c-1.1-98.4-81.5-178.2-180.5-179.1z"
        ></path>
        <path
          fill="#FFF"
          d="M7.1 37.3V84c127.4.1 231.1 102.5 232.1 228.9h45.5c-1-151.5-125-274.6-277.6-275.6z"
        ></path>
        <path
          fill="#FFF"
          d="M312.9 193.5V97.6c-11.8-16.1-25.9-33.4-40.4-47.8-16-15.9-34.1-30.1-52.3-42.7H119c88.3 31.8 159.1 100.1 193.9 186.4z"
        ></path>
        <path
          fill="#606"
          d="M7.1 180.6v117.1c0 8.4 6.8 15.3 15.3 15.3H142c-1-73.2-61.1-132.3-134.9-132.4zM7.1 84.1v49.8c99 .9 179.4 80.7 180.4 179.1h51.7C238.2 186.6 134.5 84.2 7.1 84.1z"
        ></path>
        <path
          fill="#606"
          d="M312.9 297.6V193.5C278.1 107.2 207.3 38.9 119 7.1H22.4C14 7.1 7.1 13.9 7.1 22.4v15c152.6.9 276.6 124 277.6 275.6h13c8.4-.1 15.2-6.9 15.2-15.4zM272.6 49.8c14.5 14.4 28.6 31.7 40.4 47.8V22.4c0-8.4-6.8-15.3-15.3-15.3h-77.3c18 12.6 36.2 26.8 52.2 42.7z"
        ></path>
      </g>
    </svg>
  );
...
function CIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="32.186 20.47 223.685 247.06"
    >
      <path
        fill="#004482"
        d="M252.71 93.61a21.67 21.67 0 00-2.65-10.87 20.74 20.74 0 00-7.87-7.67Q198.77 50 155.32 25c-7.8-4.51-15.36-4.35-23.11.23C120.69 32 63 65.09 45.81 75.06c-7.08 4.1-10.52 10.38-10.52 18.54v100.8a21.77 21.77 0 002.55 10.66 20.63 20.63 0 008 7.88c17.19 10 74.89 43.05 86.41 49.85 7.75 4.58 15.31 4.74 23.12.23q43.41-25.08 86.87-50.09a20.63 20.63 0 008-7.88 21.77 21.77 0 002.55-10.66V93.61z"
      ></path>
      <path
        fill="#00599c"
        d="M252.73 194.4a21.72 21.72 0 01-2.55 10.66 18.58 18.58 0 01-1.45 2.24L144 144l98.19-68.93a20.72 20.72 0 017.86 7.67 21.57 21.57 0 012.66 10.87c.02 33.6.02 100.79.02 100.79z"
      ></path>
      <path
        fill="#659ad2"
        d="M250.05 82.74L37.81 205.06a21.75 21.75 0 01-2.53-10.65V93.6c0-8.16 3.45-14.44 10.52-18.54C63 65.09 120.69 32 132.22 25.21c7.73-4.58 15.3-4.74 23.1-.23q43.41 25.08 86.87 50.09a20.72 20.72 0 017.86 7.67z"
      ></path>
      <path
        fill="#fff"
        d="M148.2 184.72a39.91 39.91 0 01-35-20.63q-.53-.94-1-1.92A39.94 39.94 0 01179 119.4c.53.64 1 1.31 1.53 2 .24.33.48.66.7 1l35.07-20.2q-1.28-2.06-2.68-4c-.49-.69-1-1.35-1.48-2A79.9 79.9 0 0078 181.92c.34.64.69 1.27 1 1.9a79.91 79.91 0 00136.86 3.62l-34.29-20.73a39.88 39.88 0 01-33.37 18.01z"
      ></path>
    </svg>
  );
}

function CPlusPlusIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      preserveAspectRatio="xMinYMin meet"
...
function PhpIcon() {
  return (
    <svg
      ...
      viewBox="0 0 256 134"
    >
      <g fillRule="evenodd" transform="translate(0 64)">
        <ellipse
          cx="128"
          cy="66.63"
          fill="#8993BE"
    ...
    <Container>
      <Box sx={{ my: 4, display: 'flex',
        ...
        <p><Typography sx={{ textAlign: "center" }}>
          <Chip
            icon={<SvgIcon><GolangIcon /></SvgIcon>}
            label="Go"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
          ...
          />&nbsp;
          <Chip
            icon={<SvgIcon><JavaScriptIcon /></SvgIcon>}
            label="JavaScript"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
            icon={<SvgIcon><NodeJsIcon /></SvgIcon>}
            label="Node.js"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
          ...
          />&nbsp;
          <Chip
            icon={<SvgIcon><PostgreSqlIcon /></SvgIcon>}
            label="PostgreSQL"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
            icon={<SvgIcon><RedisIcon /></SvgIcon>}
            label="Redis"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
            icon={<SvgIcon><MqttIcon /></SvgIcon>}
            label="MQTT"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
            icon={<SvgIcon><GnuLinuxIcon /></SvgIcon>}
            label="GNU/Linux"
            sx={{ mb: 1 }}
          />
          {/* <Chip
        ...
        <p><Typography sx={{ textAlign: "center" }}>
          ...
          />&nbsp;
          <Chip
            icon={<SvgIcon><CIcon /></SvgIcon>}
            label="C"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
            icon={<SvgIcon><CPlusPlusIcon /></SvgIcon>}
            label="C++"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
          ...
          />&nbsp;
          <Chip
            icon={<SvgIcon><PhpIcon /></SvgIcon>}
            label="PHP"
            sx={{ mb: 1 }}
          />&nbsp;
          <Chip
            icon={<SvgIcon><JavaIcon /></SvgIcon>}
            label="Java"
            sx={{ mb: 1 }}
          />&nbsp;
        </Typography></p>
